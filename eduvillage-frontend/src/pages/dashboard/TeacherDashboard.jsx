...
//     const courses = response.data; // Extract data from response
...
//   }
// };
//   // Mock chart data for monthly earnings
//   const monthlyData = [
//     { month: "Jan", value: 45 },
//     { month: "Feb", value: 62 },
//     { month: "Mar", value: 38 },
...
//   return (
//     <div className="min-h-screen bg-[#01181F] text-white">
//       <div className="flex">
//         {/* Sidebar */}
//         <aside className="w-64 bg-[#012136] min-h-screen p-6 sticky top-0">
//           {/* Logo */}
//           <div className="mb-8">
...
//               </div>
//               <span className="text-xl font-bold text-white">EduVillage</span>
//             </div>
//           </div>
...
//               className="flex items-center space-x-3 px-4 py-3 rounded-lg bg-linear-to-r from-[#1B9AAA] to-[#16808D] text-white shadow-lg"
//             >
...
//             <Link
//               to="/teacher/courses"
//               className="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-300 hover:bg-[#02394A] transition-colors"
//             >
//               <span className="text-xl">📚</span>
...
//           {/* Promotion Card */}
//           <div className="mt-8 bg-linear-to-br from-[#22C55E] to-[#178740] rounded-xl p-4">
//             <p className="text-sm font-semibold mb-2">Upgrade to Pro</p>
//             <p className="text-xs opacity-90 mb-3">Get premium features</p>
//             <div className="bg-white/20 rounded-lg p-3 mb-3">
//               <p className="text-lg font-bold">20% off</p>
//             </div>
//             <button className="w-full bg-white text-[#178740] py-2 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors">
//               Learn More
//             </button>
//           </div>
//         </aside>
...
//                   className="bg-[#02394A] border border-[#4C97A8]/30 rounded-lg px-4 py-2 pl-10 text-sm focus:outline-none focus:border-[#1B9AAA] w-64"
//                 />
//                 <span className="absolute left-3 top-2.5 text-gray-400">🔍</span>
//               </div>

//               {/* Notification */}
//               <button className="relative bg-[#02394A] p-2 rounded-lg hover:bg-[#4C97A8]/20 transition-colors">
//                 <span className="text-xl">🔔</span>
//                 <span className="absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full"></span>
//               </button>

//               {/* User Avatar */}
//               <div className="flex items-center space-x-2 bg-[#02394A] px-3 py-2 rounded-lg">
...
//               </div>
//               <h3 className="text-gray-400 text-sm mb-1">Draft Courses</h3>
//               <p className="text-3xl font-bold">{stats.draftCourses}</p>
//             </div>

//             {/* Total Students */}
//             <div className="bg-[#02394A] rounded-xl p-6 border border-[#4C97A8]/20 hover:border-[#CCE7EC] transition-all duration-300 transform hover:-translate-y-1">
//               <div className="flex items-center justify-between mb-4">
//                 <div className="bg-linear-to-br from-[#CCE7EC]/20 to-[#4C97A8]/20 p-3 rounded-full">
//                   <span className="text-3xl">👥</span>
//                 </div>
...
//             <div className="lg:col-span-2 bg-[#02394A] rounded-xl p-6 border border-[#4C97A8]/20">
//               <div className="flex justify-between items-center mb-6">
//                 <h2 className="text-xl font-bold">Monthly Performance</h2>
//                 <select className="bg-[#01181F] border border-[#4C97A8]/30 rounded-lg px-3 py-1 text-sm focus:outline-none focus:border-[#1B9AAA]">
...
//                       {/* Tooltip */}
//                       {index === 5 && (
//                         <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-linear-to-r from-[#22C55E] to-[#178740] px-3 py-1 rounded-lg text-sm font-bold whitespace-nowrap">
//                           {data.value}%
//                         </div>
//                       )}
...
//                             : "bg-linear-to-t from-[#4C97A8]/30 to-[#4C97A8]/10"
//                         } group-hover:from-[#1B9AAA] group-hover:to-[#16808D] relative overflow-hidden`}
//                         style={{
...
//             {/* Activity Map */}
//             <div className="bg-[#02394A] rounded-xl p-6 border border-[#4C97A8]/20">
//               <h2 className="text-xl font-bold mb-6">Student Activity</h2>
              
//               {/* World Map Placeholder */}
//               <div className="bg-[#01181F] rounded-lg p-4 mb-4 h-40 flex items-center justify-center">
...
//                       <span className="text-gray-300">{activity.city}</span>
//                       <span className="font-bold">{activity.percentage}%</span>
//                     </div>
//                     <div className="w-full bg-[#01181F] rounded-full h-2 overflow-hidden">
//                       <div
//                         className={`h-2 bg-linear-to-r ${activity.color} rounded-full transition-all duration-500 relative overflow-hidden`}
...
//           <div className="mt-8 bg-[#02394A] rounded-xl p-6 border border-[#4C97A8]/20">
//             <div className="flex justify-between items-center mb-6">
//               <h2 className="text-xl font-bold">Recent Courses</h2>
//               <button className="text-sm text-[#1B9AAA] hover:text-[#CCE7EC] flex items-center gap-1">
//                 <span>Sort by</span>
//                 <span>▼</span>
//               </button>
//             </div>
...
//             {/* Table Header */}
//             <div className="grid grid-cols-5 gap-4 text-sm text-gray-400 mb-4 pb-2 border-b border-[#4C97A8]/20">
//               <div>Course Name</div>
//               <div>Category</div>
//               <div>Level</div>
//               <div>Status</div>
...
//                   <div
//                     key={course._id}
//                     className="grid grid-cols-5 gap-4 items-center py-3 hover:bg-[#01181F]/50 rounded-lg px-2 transition-colors"
//                   >
//                     <div className="flex items-center gap-3">
//                       <div className="w-10 h-10 bg-linear-to-br from-[#1B9AAA] to-[#16808D] rounded-lg flex items-center justify-center shrink-0">
//                         <span>📚</span>
//                       </div>
//                       <div>
...
//                           course.isPublished
//                             ? "bg-linear-to-r from-[#22C55E] to-[#178740]"
//                             : "bg-linear-to-r from-[#EF4444]/20 to-[#EB1414]/20 text-[#EF4444]"
//                         }`}
//                       >
...
//                         className="text-sm text-[#1B9AAA] hover:text-[#CCE7EC] font-medium"
//                       >
//                         Manage →
//                       </Link>
//                     </div>
        ...
        <aside className="w-64 bg-white min-h-screen p-6 sticky top-0 shadow-lg border-r border-[#CCE7EC]">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-[#142C52]">EduVillage</span>
            </div>
          </div>
